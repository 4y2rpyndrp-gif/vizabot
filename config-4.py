...
# Ma'lumotlar bazasi fayli. Railway'da "Volume" ulanganda DB_PATH o'zgaruvchisini
# shu volume manziliga (masalan /data/vizabot.db) sozlang - aks holda ma'lumotlar
# har deploy'da o'chib ketishi mumkin!
